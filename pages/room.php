...
$rs=$obj->showRoom();
if(isset($_GET['del'])){
   $obj->deleteRoom(intval($_GET['del']));
}
if(isset($_POST['addRoom'])){
   extract($_POST);
   $obj->addRoom($roomNumber,$bedPerRoom,$rentPerBed,$floorId);
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="">
          <div class="row">
            <div class="col-md-12 col-sm-12  ">
             <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-bed" aria-hidden="true"></i> Room Detail</h2>
                ...
                <div class="x_content">
                  <ul class="nav nav-tabs">
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href="?page=room"> <i class="fa fa-list-ol"></i> Room Info</a>
                    </li>
                    <li class="nav-item">
                      ...
                      <div class="card-box table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="color: #5a738e">
                          ...
                          <tbody>
                            ...
                            <tr class="">
                              <td><?php echo $sn?></td>
                              <td><?php echo htmlentities( strtoupper($res->floorname));?></td>
                              <td><?php echo htmlentities(strtoupper($res->roomNumber));?></td>
                              <td><?php echo htmlentities($res->bedPerRoom);?></td>
                              <td><?php echo htmlentities($res->rentPerBed);?></td>
                              <td>&nbsp;&nbsp;<a href="editRoom.php?room_id=<?php echo htmlentities($res->id);?>"><button class="btn btn-info"><i class="fa fa-edit"></i> Edit</button></a>
                                <a href="room.php?del=<?php echo htmlentities($res->id); ?>">
